        ...
        <app-card>
          ...
          <ul class="mb-3 p-0">
            ...
            <li class="d-flex align-items-center mb-25">
              ...
              <span class="ml-auto clr-primary">${{ newTransfer.amount }}</span>
            </li>
            <li class="d-flex align-items-center mb-25">
              <span>Transfer Fee</span>
              <span class="ml-auto clr-primary">${{ user.fees.payment }}</span>
            </li>
            <li class="d-flex align-items-center mb-25">
          ...
          <div v-if="newTransfer.reference.length > 0">
            ...
            <p class="font-italic">{{ newTransfer.reference }}</p>
          </div>
          ...
          <ul class="mb-3 p-0">
            ...
            <li class="d-flex align-items-center mb-25">
              ...
              <span class="ml-auto text-right font-weight-500 clr-primary h4">${{ newTransfer.amount + user.fees.payment }}</span>
            </li>
          </ul>
...
export default {
  ...
  methods: {
    addTransfer() {
      ...
      this.$store.dispatch('transfer/newTransfer', formData)
    },
